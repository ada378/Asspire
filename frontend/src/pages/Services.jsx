...
const services = [
  { id: 'web-development', icon: FaGlobe, title: 'Web Development', desc: 'Custom websites and web applications built with modern frameworks — responsive, fast, secure, and built to scale.', features: ['Custom web apps', 'Responsive design', 'API integration', 'Performance optimization'] },
...
const techStacks = [
  { name: 'JS Full Stack', icon: SiMongodb, items: ['MongoDB', 'Express.js', 'React.js', 'Node.js'], desc: 'Best for startups & SaaS products' },
