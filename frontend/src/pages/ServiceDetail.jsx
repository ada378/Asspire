...
const serviceData = {
  'web-development': {
    ...
    description: 'We build production-grade websites and web applications using modern frameworks and best practices. Our development process follows industry standards including component-based architecture, responsive design, API-first development, and comprehensive testing — ensuring your project is fast, secure, and scalable.',
    features: [
    ...
    tech: ['React.js', 'Next.js', 'Node.js', 'TypeScript', 'Tailwind CSS', 'PostgreSQL', 'MongoDB'],
  },
  'mobile-apps': {
    title: 'Mobile Apps',
    icon: FaMobileAlt,
